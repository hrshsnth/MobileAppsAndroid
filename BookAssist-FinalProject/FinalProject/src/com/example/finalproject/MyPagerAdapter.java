...
ViewPager.OnPageChangeListener {
	...
	public MyPagerAdapter(MainMenuActivity context, FragmentManager fm, ArrayList<Book> bookList) {
		super(fm);
		this.fm = fm;
	...
	public Fragment getItem(int position) 
	{
		...
		Fragment curFragment= MyFragment.newInstance(context, position, scale,listBook,IsBlured);
